...
public class UsuarioRestController {
    ...
    public Usuario findById(@PathVariable long id) {
    	Usuario userFind = this.usuarioService.findById(id).clone();
    ...
    public Usuario create(@RequestBody Usuario usuario) {
    	if (usuario!=null && usuario.getImage()!=null && usuario.getImage().getPicByte()!=null) {
    		usuario.getImage().setPicByte(compressBytes(usuario.getImage().getPicByte())); 
		}
        return usuarioService.save(usuario);
    }
    
    @PostMapping("/usuarios-image/{id}")
    public Usuario createImage(@RequestParam("imageFile") MultipartFile file,@PathVariable long id) {
    ...
    public Usuario edit(@PathVariable long id,@RequestBody Usuario usuario) {
        ...
        return this.usuarioService.edit(id, usuario);
    }
